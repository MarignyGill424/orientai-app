...
const generateProfileMutation = useMutation({
  mutationFn: async (data: OrientationFormData) => {
    const response = await fetch("http://localhost:3000/api/orientation", {
      method: "POST",
      headers: {
...
onSuccess: (data) => {
  ...
  if (data.success) {
    onShowResults(data.suggestions, data.profileId);
    toast({
      title: "Profil généré avec succès ! 🎉",
      description: "Découvre tes suggestions de carrière personnalisées.",
    });
  } else {
      ...
      <form ref={formRef} onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8">
          ...
          <CardContent className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Select onValueChange={(value) => form.setValue("genre", value as any)}>
                  <SelectTrigger>
                    <SelectValue placeholder="-- Choisis ton genre --" />
                  </SelectTrigger>
                  <SelectContent>
              ...
              <div>
                ...
                <Select onValueChange={(value) => form.setValue("disponibilite", value as any)}>
                  <SelectTrigger>
                    <SelectValue placeholder="-- Quand es-tu dispo ? --" />
                  </SelectTrigger>
                  <SelectContent>
                    <SelectItem value="Immédiate">Immédiate</SelectItem>
                    <SelectItem value="Sous 1 mois">Sous 1 mois</SelectItem>
                    <SelectItem value="À partir d'une date">À partir d'une date précise</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
          ...
          <CardContent className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div>
                ...
                <Select onValueChange={(value) => form.setValue("objet", value)}>
                  <SelectTrigger>
        ...
        >
          <CardContent className="p-8">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Quel est ton style d'apprentissage préféré ?</h3>
                    ...
                    <Card key={option.value} className="border-2 hover:border-indigo-500 transition-colors cursor-pointer">
                      <CardContent className="p-6">
                        <div className="flex flex-col items-center text-center">
                          ...
                          <Label htmlFor={`apprentissageStyle-${option.value}`} className="font-medium">
                            {option.label}
                          </Label>
                          <span className="text-sm text-gray-600 mt-1">
                            {option.value === "Visuel" && "Images, schémas, couleurs"}
                            {option.value === "Auditif" && "Écouter, podcasts, musique"}
                            {option.value === "Kinesthésique" && "Manipuler, expérimenter"}
                          </span>
                        </div>
                      </CardContent>
                    </Card>
        ...
        >
          <CardContent className="p-8">
            ...
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Où te sens-tu le plus à l'aise pour travailler ?</h3>
            ...
            <div>
              <Label>Le télétravail est-il envisageable ?</Label>
              <RadioGroup
                onValueChange={(value) => form.setValue("teletravail", value as any)}
                className="flex space-x-4 mt-2"
              >
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="Oui" id="teletravail-oui" />
                  <Label htmlFor="teletravail-oui">✅ Oui</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="Non" id="teletravail-non" />
                  <Label htmlFor="teletravail-non">❌ Non</Label>
                </div>
              </RadioGroup>
            </div>
          </CardContent>
        ...
        >
          <CardContent className="p-8">
            ...
            <div className="mb-8">
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Valeurs phares (notation de 1 à 5)</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">5 = Très important, 1 = Pas important</p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Valeurs générales</h3>
        ...
        >
          <CardContent className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <Label>As-tu déjà eu une expérience de travail ou de bénévolat ?</Label>
              ...
              <div>
                <Label htmlFor="experience_details">Précise ton expérience (si tu en as une)</Label>
                <Textarea
                  id="experience_details"
                  rows={3}
                  placeholder="Décris tes expériences de travail, stages, bénévolat..."

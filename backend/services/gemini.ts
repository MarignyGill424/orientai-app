...
export async function generateOrientationSuggestions(formulaire: any) {
  ...
  try {
    console.log("📤 Appel à generateIntroduction...");
    const intro = await generateIntroduction(formulaire);
    console.log("✅ Intro générée :", intro);

    console.log("📤 Appel à generateProfilPrincipal...");
    const profil = await generateProfilPrincipal(formulaire);
    console.log("✅ Profil généré :", profil);

    console.log("📤 Appel à generateInterpretations...");
    const interpretations = await generateInterpretations(formulaire);
    console.log("✅ Interprétations générées :", interpretations);
